        ...
        <div class="card">
            <div class="card-body">
                <div class="table_section padding_infor_info">
                    <form class="form-horizontal" method="POST" action="{{ route('backend.mitra.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-group">
                                ...
                                <input type="text" name="nama" class="form-control" placeholder="Nama Mitra" value="{{ old('nama') }}">
                                @if ($errors->has('nama'))
