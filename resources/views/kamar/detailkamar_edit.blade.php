...
@section('title', 'Edit Detail Kamar')
@section('content')

    <div class="page_title">
        <h2>Edit Detail Kamar</h2>
    </div>
                ...
                <div class="card-body">
                    <div class="table_section padding_infor_info">
                        <div class="form-group">
                            <form class="form-horizontal" method="POST" action="{{ route('backend.detail-kamar.update', $detailKamar->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                @if ($errors->any())
                                ...
                                <div class="col-sm-6 input-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="text" name="nama_kamar" class="form-control"
                                            placeholder="Nama Kamar" value="{{ $detailKamar->nama_kamar }}">
                                    </div>
                                </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-group">
                                ...
                                <select type="text" name="jenis_ruang_id" class="selectize-jenis"
                                    ...
                                    @foreach ($jeniskamar as $jenis)
                                        <option value="{{ $jenis->id }}" @if ($detailKamar->jenis_ruang_id == $jenis->id) selected @endif>{{ $jenis->nama_ruang }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 input-group">
                                ...
                                <input type="text" name="tempat_tidur" class="form-control" placeholder="Jumlah Tempat Tidur"
                                    value="{{ $detailKamar->tempat_tidur }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-group">
                                ...
                                <input type="text" name="harga" class="form-control" placeholder="Tambahkan Harga"
