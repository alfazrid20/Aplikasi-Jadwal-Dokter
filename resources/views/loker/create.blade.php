        ...
        <div class="card">
            <div class="card-body">
                <div class="table_section padding_infor_info">
                    <form class="form-horizontal" method="POST" action="{{ route('backend.loker.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-group">
                                ...
                                <input type="text" name="posisi_id" class="form-control" placeholder="Posisi" value="{{ old('posisi_id') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12 input-group">
                                ...
                                <textarea name="deskripsi" id="editor2" class="form-control bigger-textarea" rows="6">{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12 input-group">
                                ...
                                <textarea name="persyaratan" id="editor3" class="form-control bigger-textarea" rows="6">{{ old('persyaratan') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 input-group">
                                ...
                                <input type="date" name="batas_waktu" class="form-control" placeholder="Batas Waktu" value="{{ old('batas_waktu') }}">
