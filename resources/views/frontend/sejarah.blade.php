        ...
        <div class="row g-5">
          <div class="col-lg-12">
            <article class="blog-details">
              <div class="post-img">
                <img src="{{ asset('frontend/img/rs.png') }}" alt="" class="img-fluid">
              </div>
              <h2 class="title">Sejarah Rumah Sakit Umum Aisyiyah Padang</h2>
              <div class="content">
                <p>
                ...
                <p>
                  Memperhatikan keadaan tersebut ibu-ibu Aisyiyah Cabang Padang Barat melalui Yayasan Klinik Bersalin Aisyiyah (YKBA) memprakarsai berdirinya Balai Kesehatan Ibu dan Anak (BKIA) serta persalinan, kemudian dirobah menjadi Rumah Sakit Bersalin Aisyiyah (RSB’A) di awal tahun tujuh puluhan. Segala daya dan upaya dikerahkan oleh Aisyiyah baik tingkat ranting, cabang dan partisipasi anggota Aisyiyah tidak lagi terbatas pada cabang Padang Barat dan Kota Padang saja tapi mengikutsertakan seluruh cabang dan ranting se Sumatera Barat.
                </p>
                ...
                <blockquote>
                  <p>
                   <i>"SIIP"
                    <br>
                    "Santun, Ikhlas, Peduli, Profesional"</i> 
                   <br>
                   <p>
                    Merupakan Motto Yang Dipakai dan Diterapkan RSU Aisyiyah Padang Saat Ini
                   </p>
                  </p>
                </blockquote>
                ...
                <blockquote>
                  <p>
                    “Menjadi Rumah Sakit Pilihan yang profesional, handal dan bermutu dalam memberikan Pelayanan Kesehatan yang Paripurna di Sumatera Barat tahun 2028”
                  </p>
                </blockquote>
                <h3 class="text-center">Misi</h3>
                <blockquote>
                 <i> "1. Menyelenggarakan pelayanan kesehatan secara profesional yang mengutamakan mutu dan keselamatan dengan mengikuti " perkembangan ilmu pengetahuan dan teknologi terkini.
                 <br>
                 2. Menyediakan sarana prasarana yang lengkap, handal dan efektif
                 <br>
                 3. Meningkatkan kualitas Sumber Daya Insani secara berkelanjutan
                 <br>
                 4. Melaksanakan sistem keuangan yang efisien, efektif dan akuntabel
                 </i>
                </blockquote>
              </div>
            </article>
